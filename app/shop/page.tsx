...
export const metadata = { title: "Smart Technology Shop | KI Analysix System", description: "Complete TAOS smart-device catalogue with model-level compatibility guidance, installation support and project configuration." };
