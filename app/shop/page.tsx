...
export const metadata = { title: "Smart Technology Shop | KI Analysix System", description: "Complete TAOS smart-switch and smart-lighting ranges with Tuya-compatible products, installation and project configuration." };
